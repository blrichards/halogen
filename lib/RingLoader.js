...
var Loader = function (_Component) {
  ...
  function Loader() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.getCircleStyle = function (size) {
      return {
        width: size,
        height: size,
      ...
      if (i) {
        return (0, _appendVendorPrefix2.default)(_this.getCircleStyle(size), _this.getAnimationStyle(i), {
          position: 'absolute',
          top: 0,
          left: 0
        });
